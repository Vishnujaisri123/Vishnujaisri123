...
<picture>
  ...
  <img src="./banner.svg?v=2" alt="KJSS Vishnu Vardhan — Full Stack &amp; AI/ML Engineer" width="100%"/>
</picture>
...
<!-- 🪪 Swinging Lanyard Hunter Card (custom SVG with embedded cartoon man avatar) -->
<img src="./lanyard.svg?v=2" alt="Vishnu Vardhan S-Rank Hunter Card" width="330"/>
...
| 🎌 Project | 💻 Tech | ⭐ |
|:---|:---:|:---:|
| [⚔️ Quest Intelligence System](https://github.com/Vishnujaisri123/Quest-Intelligence-System) | `Python` `OpenCV` `LLM APIs` | 15 |
| [📈 StockFlow — Microservices](https://github.com/Vishnujaisri123/Internship_project) | `Python` `Node.js` `MongoDB` `Redis` | 12 |
| [💰 MY-PROFITS — Portfolio Tracker](https://github.com/Vishnujaisri123/MY-PORTFOLIO) | `React` `Node.js` `WebSockets` | 10 |
| [📊 Customer Churn Analysis](https://github.com/Vishnujaisri123/Internship_project) | `Python` `Scikit-Learn` | 6 |
...
<!-- GitHub Stats using dark radical/tokyonight cyber theme -->
